...
def main():
    ...
    req_var ={'CS_UPLOAD_BUCKET', 'AWS_KEY', 'SPC_NUM_CLUSTERS', 'VS_N_DONOR', 'CR_DOWNLOAD_BUCKET', 'SPC_UPLOAD_BUCKET', 'CR_CORE', 'SAMPLE_ID', 'CS_MIN_MAF', 'AWS_SECRET_KEY', 'CR_UPLOAD_BUCKET', 'VS_UPLOAD_BUCKET', 'SPC_THREADS', 'CR_MEMORY', 'CR_EXPECT_CELLS', 'CS_MIN_COUNT', 'CS_THREADS', 'REGION'}
